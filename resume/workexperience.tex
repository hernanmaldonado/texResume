...
%--------BANK OF AMERICA
\resumeSubheading
{\href{https://www.bankofamerica.com/}{Bank of America}, Tampa FL}{Oct 2023 -- Dec 2023}
{Consumer Protection Big Data and Machine Learning Consultant}{Hybrid}
\resumeItemListStart
...
%--------CITI
\resumeSubheading
{\href{https://www.citigroup.com/global}{Citigroup}, Tampa FL}{May 2022 -- Oct 2023}
{Systems Engineer (Machine Learning)}{Hybrid}
\resumeItemListStart
...
\resumeItem{\textbf{Mentorship: }Supervised the development, implementation and monitoring of multiple machine learning models.}
...
%--------CERTEGY
\resumeSubheading
{\href{https://certegy.com/}{Certegy}, Tampa FL}{May 2021 -- Apr 2022}
{Data Scientist, Tampa Florida}{Hybrid}
\resumeItemListStart
...
%--------NIELSEN
\resumeSubheading
{\href{https://www.nielsen.com/}{Nielsen}, Tampa FL}{Feb 2021 -- Apr 2021}
...
\resumeSubheading
{\href{https://www.citigroup.com/global}{Citigroup}, Tampa FL}{Apr 2018 -- Feb 2021}
{Cybersecurity Big Data and Machine Learning Engineer}{Hybrid}
\resumeItemListStart
...
%--------HSAG
\resumeSubheading
{\href{https://www.hsag.com/}{Health Services Advisory Group (HSAG)}, Tampa FL}{Jan 2018 -- Apr 2018}
{Quality Measures Analyst}{On-Site}
\resumeItemListStart
...
%--------WELLCARE
\resumeSubheading
{\href{https://www.wellcare.com/}{Wellcare Health Plans (Acquired by Centene)}, Tampa FL}{May 2016 -- Oct 2017}
{Data Scientist, Machine Learning}{On-Site}
\resumeItemListStart

\resumeItem{\textbf{Machine Learning: }Reduced hospital readmissions by 60\% by implementing a machine learning model using Scikit learn and XGBOOST in Python to flag people that were likely to be readmitted to the hospital. Hospital readmissions are a significant problem for health insurance companies as they get penalized by Medicare when this happens.}
...
%--------GATEWAY
\resumeSubheading
{\href{https://www.highmark.com/}{Gateway HealthPlan (Acquired by Highmark)}, Pittsburgh PA}{Jan 2015 -- Apr 2016}
{Quality Measures Analyst}{On-Site}
\resumeItemListStart
...
%--------UPMC
\resumeSubheading
{\href{https://www.upmchealthplan.com/}{UPMC Health Plan}, Pittsburgh PA}{Aug 2012 -- Oct 2014}
{ETL, Database Analsyt}{On-Site}
\resumeItemListStart
...
\resumeSubheading
{\href{https://www.pitt.edu/}{University of Pittsburgh}, Pittsburgh PA}{Jan 2011 -- Aug 2012}
{Project Manager}{On-Site}
\resumeItemListStart
\resumeItem{\textbf{Management:} Managed all aspects of two grant \$1.5M funded research projects. Completed all data collection ahead of schedule and under budget. The projects were featured on local TV for their positive impact on the community and I was the interviewee for the program. Hiring personnel (about 20 employees), training, supervision, supervise study participants recruitment, data collection and performance reporting. }
